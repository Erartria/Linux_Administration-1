...
#10
cat /etc/group | grep g1 | awk -F ":" '{print "g1 users: " $4}' >> ~/work3.log
...
#14
groupadd access_to_test13
usermod -aG access_to_test13 u1
usermod -aG access_to_test13 u2
chown u1:access_to_test13 /home/test13
...
#17
mkdir /home/test15
echo "bruuuuuh..." > /home/test15/secret_file 
